    ...
    <form class="col-md-4 col-md-offset-4 col-sm-12" method="post" action="<?php $_SERVER['PHP_SELF']; ?>" >
        <fieldset>
            <div class="center whiteOpacity">
                <label for username>Username &nbsp; </label><input type = "text" name="username" size="15" autofocus>
                <br>
                <br>
                <label for password>Password &nbsp; </label><input type = "password" name="password" size="15" onkeypress="capLock(event)" />
